...
import RedeemingYourTime from "../assets/redeemingYourTime.webp";

export const mockData: BlogListProps = {
  posts: [
        {
      id: "redeeming-your-time",
      title: "Redeeming Your Time",
      content: '',
      date: "2024-04-11",
      url: "https://www.bible.com/reading-plans/27704-redeeming-your-time",
      coverImg: RedeemingYourTime,
      series: "Jesus was the most productive person who ever lived. In this seven-day reading plan, we will unearth 7 timeless principles from the gospel biographies that will help us be more purposeful, present, and productive—“redeeming our time” (Eph. 5:16) for the glory of God and the good of others.",
      scriptures: [
        { verse: "Luke 8:22", day: 1 },
        { verse: "Ephesians 2:14", day: 1 },
        { verse: "John 1:14", day: 1 },
        { verse: "Mark 1:35", day: 1 },
        { verse: "Luje 6:12", day: 1 },
        { verse: "Matthew 5:37", day: 2 },
        { verse: "Philippians 4:6", day: 2 },
        { verse: "2 Corinthians 8:11", day: 2 },
        { verse: "James 5:12", day: 2 },
        { verse: "Numbers 30:1", day: 2 },
        { verse: "Acts 2:38", day: 3 },
        { verse: "Luke 4:42", day: 3 },
        { verse: "Luke 5:15", day: 3 },
        { verse: "Luke 6:11", day: 3 },
        { verse: "Matthew 14:13", day: 3 },
        { verse: "Mark 1:9", day: 3 },
        { verse: "Psalms 10:4", day: 3 },
        { verse: "Psalms 46:10", day: 3 },
        { verse: "Mark 1:29", day: 4 },
        { verse: "Luke 10:38", day: 4 },
        { verse: "Luke 9:51", day: 4 },
        { verse: "Luke 17:4", day: 4 },
        { verse: "Matthew 12:46", day: 5 },
        { verse: "Mark 10:17", day: 5 },
        { verse: "Mark 5:27", day: 5 },
        { verse: "Luke 5:17", day: 5 },
        { verse: "Mark 6:30", day: 6 },
        { verse: "Mark 4:38", day: 6 },
        { verse: "Mark 2:27", day: 6 },
        { verse: "Mark 11:11", day: 7 },
        { verse: "Mark 3:20", day: 7 },
        { verse: "John 11:5", day: 7 },
      ],
      notes: [
        "Question 1: Did any particular day stood out to you guys?",
        "Question 2: Do you see anything that can be a blocker for us to spend alone time with the Lord? What can we do about it?",
        "Question 3: Does anyone struggle with letting your 'yes' be yes and your 'no' be no? How can we be more intentional about this? What does the Word say about this and why?",
        "Question 4: The bible shows us how the 'busier' Jesus got the more ogten he withdrew to spend time in silence with the Father. Why do you think that is? Do you do this? If not, how can we remind ourselves to continnually seek the Kingdom as we get busier?",
        "Question 5: Any ways that you create room for silence, stillness and reflection? What does that look like?",
